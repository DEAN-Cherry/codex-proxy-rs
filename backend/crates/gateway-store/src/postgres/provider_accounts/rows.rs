...
pub(crate) const ACCOUNT_SELECT: &str = "select location_country, location_region, location_city, location_timezone, outbound_proxy_url, id, provider_kind, name, notes, email, upstream_user_id,
            ...
            has_refresh_token, access_token_expires_at, next_refresh_at, enabled, enable_session_keepalive, session_keepalive_models, session_keepalive_expected_lengths, concurrency_limit, weight, model_access_json, credential_state,
...
pub(crate) fn core_account_from_summary(
    ...
    .with_session_keepalive_expected_lengths(summary.session_keepalive_expected_lengths)
